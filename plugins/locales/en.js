const en = {
  ...
  return_and_exchange_instructions: 'return and exchange intructions',
  ...
  t_please_enter_verification_code: 'Enter verification code',
  ...
  collect_cart_tips: 'Are you sure you want to replace this {replace_tip} items moved into my attention?',
  ...
  t_the_two_passwords_are_inconsistent: 'The two passwords do not match',
  ...
  negotiation_status_11: 'Due to the rejection of the merchant, the buyer did not intervene with the customer service within the time limit, and the after-sales order was closed',
  negotiation_status_12: 'Due to the rejection of the merchant, the buyer did not intervene with the customer service within the time limit, and the after-sales order was closed',
  ...
  customer_service_intervention: 'Customer service intervention',
  ...
  t_problem_description: 'Please enter a description of the problem',
  ...
  terms_of_service: 'Tospino service agreement',
  up_to_date: 'newest',
