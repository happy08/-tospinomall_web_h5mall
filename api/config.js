...
if (process.env.APP_MODE == 'ghana') { // 加纳站点
  production = {
    ...production,
    DOMAIN_API: 'https://tospinomallapi1.tospinomall.com',
    DOMAIN_LOGIN: 'https://oauthapi1.tospinomall.com'
  }
}

if (process.env.APP_MODE == 'vi') { // 越南站点
  production = {
    ...production,
