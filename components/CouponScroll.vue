<template>
  <!-- 商品优惠券弹窗 -->
  <van-popup v-model="isCouponShow" style="height: 80%" position="bottom" class="round-tlr-12 bg-grey coupon-popup" @click-overlay="$emit('onBeforeClose', false)">
    <h3 class="black pt-20 fs-18 pb-10 bg-white tc lh-20">{{ $t('coupon') }}</h3>
